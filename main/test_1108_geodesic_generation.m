...
for index_facet = 14398:14398% 遍历各起点（各三角面片形心点）
    ...
    for index_angle = 3:3% 遍历各初始角度
        ...
        while length_sum < length_desired
            ...
            % 绘制拟合路径点坐标系
            quiver3(point_current(1),point_current(2),point_current(3), ...
                direction_vector_W(1),direction_vector_W(2),direction_vector_W(3),0.005,'Color','r');
            hold on
