...
[size_point, point_all] = discretizeCylinderCell(r_cylinder, h_cylinder, size_theta);

%%%%%%%%%%%%%%%%%%%%%
%%% 测地线生成 %%%
%%%%%%%%%%%%%%%%%%%%%
[edge, size_edge, l_edge] = getHelixCell(size_point, point_all, r_cylinder);
...
%%% 作图 %%%
%%%%%%%%%%%%
% plotHelixCell(r_cylinder, h_cylinder, size_edge_candidate, edge_candidate, point_all, edge);
