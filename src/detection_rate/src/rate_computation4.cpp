...
void doMsg(const detection_rate::Sensor::ConstPtr &msgp1, const detection_rate::Sensor::ConstPtr &msgp2, const detection_rate::Sensor::ConstPtr &msgp3, const detection_rate::Sensor::ConstPtr &msgp4)
{    
    ...
    total_time++;
    if (msgp1_data == 1 || msgp2_data == 1 || msgp3_data == 1 || msgp4_data == 1)
    {
        successful_time++;
    }
...
int main(int argc, char *argv[])
{
    ...
    TimeSynchronizer<detection_rate::Sensor, detection_rate::Sensor, detection_rate::Sensor, detection_rate::Sensor> sync(sensor1_sub, sensor2_sub, sensor3_sub, sensor4_sub, 10);    
    sync.registerCallback(boost::bind(&doMsg, _1, _2, _3, _4));
