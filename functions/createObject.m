function [size_point, point_all_cartesian] = createObject(r_cylinder, h_cylinder, size_theta)
...
z0 = 0:interval_h_cylinder:h_cylinder;

size_z = size(z0,2); %圆柱坐标高度方向均分数
size_point = size_theta*size_z; %离散点总数

point_all_cartesian = zeros(3,size_point); %储存所有离散点圆柱坐标的数组
k = 1;
for i = 1:size_theta
    for j = 1:size_z
