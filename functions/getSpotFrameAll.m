function [spot, tform_sensor_all] = getSpotFrameAll(size_sensor, position_helix, tform, position, r_cylinder, idx_config, tform_sensor_all)
% 生成螺旋线均分点（各传感器坐标系原点）
...
for i = 1:size_sensor
    tform_sensor_all(idx_config,i) = {[x_basis(:,i), y_basis(:,i) ,z_basis, spot(:,i); 0 0 0 1]};
end
end