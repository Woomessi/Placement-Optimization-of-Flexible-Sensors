function [direction_vector_W,index_facet_current,point_current,T] = getVertexPathpoint_new(TR, index_point_current, position_vertices, facets, point_current, index_facet_current, direction_vector_W)
%%%%%%%%%%%%%%%%%
%%% 计算均分角 %%%
%%%%%%%%%%%%%%%%%
