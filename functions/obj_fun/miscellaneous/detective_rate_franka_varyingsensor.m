function detective_rate = detective_rate_franka_varyingsensor(idx_helix1, idx_helix2, idx_helix3, idx_helix4, idx_helix5, idx_helix6, idx_helix7, ring1, ring2, ring3, ring4, ring5, ring6, ring7, size_sim, r_obj_offset, theta_obj_offset, target_homo, q_all, my_robot, size_joint, X_link, F_link, edge_candidate_all1, a, d, alpha, size_spot, size_point_target, fov_vertical, fov_horizontal, h_cone)
%%%%%%%%%%%%%%%%%%%
%%% 蒙特卡洛仿真 %%%
%%%%%%%%%%%%%%%%%%%
idx_helix = [idx_helix1, idx_helix2, idx_helix3, idx_helix4, idx_helix5, idx_helix6, idx_helix7];
rings = [ring1, ring2, ring3, ring4, ring5, ring6, ring7];
