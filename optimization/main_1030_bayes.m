...
idx_link2 = optimizableVariable('idx_link2',[0,6],'Type','integer');
idx_link3 = optimizableVariable('idx_link3',[0,6],'Type','integer');
idx_link4 = optimizableVariable('idx_link4',[0,6],'Type','integer');
idx_link5 = optimizableVariable('idx_link5',[0,6],'Type','integer');
idx_link6 = optimizableVariable('idx_link6',[0,6],'Type','integer');
...
% fun = @(x)getDetectiveRate_double(x.idx_link1, x.idx_link2, x.idx_geodesic0, x.idx_geodesic1, x.idx_geodesic2, x.idx_geodesic3, x.idx_geodesic4, x.idx_geodesic5, x.idx_geodesic6,  size_spot, size_point_target, size_sim, r_obj_offset, theta_obj_offset, target_homo, q_all, my_robot, size_joint, all_tform_spot_link0, all_tform_spot_link1, all_tform_spot_link2, all_tform_spot_link3, all_tform_spot_link4, all_tform_spot_link5, all_tform_spot_link6, fov_vertical, fov_horizontal, h_cone);
% results = bayesopt(fun,[idx_link1, idx_link2, idx_geodesic0, idx_geodesic1, idx_geodesic2, idx_geodesic3, idx_geodesic4, idx_geodesic5, idx_geodesic6],'UseParallel',true,'PlotFcn',{@plotAcquisitionFunction,@plotObjectiveModel,@plotObjective,@plotMinObjective});

%%%%%%%%%%%%%%%%%%%%%%%%
%%% 使用3个柔性传感器 %%%
%%%%%%%%%%%%%%%%%%%%%%%%

% fun = @(x)getDetectiveRate_3(x.idx_link1, x.idx_link2, x.idx_link3, x.idx_geodesic0, x.idx_geodesic1, x.idx_geodesic2, x.idx_geodesic3, x.idx_geodesic4, x.idx_geodesic5, x.idx_geodesic6,  size_spot, size_point_target, size_sim, r_obj_offset, theta_obj_offset, target_homo, q_all, my_robot, size_joint, all_tform_spot_link0, all_tform_spot_link1, all_tform_spot_link2, all_tform_spot_link3, all_tform_spot_link4, all_tform_spot_link5, all_tform_spot_link6, fov_vertical, fov_horizontal, h_cone);
% results = bayesopt(fun,[idx_link1, idx_link2, idx_link3, idx_geodesic0, idx_geodesic1, idx_geodesic2, idx_geodesic3, idx_geodesic4, idx_geodesic5, idx_geodesic6],'MaxObjectiveEvaluations',60,'UseParallel',true,'PlotFcn',{});

%%%%%%%%%%%%%%%%%%%%%%%%
%%% 使用4个柔性传感器 %%%
%%%%%%%%%%%%%%%%%%%%%%%%

fun = @(x)getDetectiveRate_4(x.idx_link1, x.idx_link2, x.idx_link3, x.idx_link4, x.idx_geodesic0, x.idx_geodesic1, x.idx_geodesic2, x.idx_geodesic3, x.idx_geodesic4, x.idx_geodesic5, x.idx_geodesic6,  size_spot, size_point_target, size_sim, r_obj_offset, theta_obj_offset, target_homo, q_all, my_robot, size_joint, all_tform_spot_link0, all_tform_spot_link1, all_tform_spot_link2, all_tform_spot_link3, all_tform_spot_link4, all_tform_spot_link5, all_tform_spot_link6, fov_vertical, fov_horizontal, h_cone);
results = bayesopt(fun,[idx_link1, idx_link2, idx_link3, idx_link4, idx_geodesic0, idx_geodesic1, idx_geodesic2, idx_geodesic3, idx_geodesic4, idx_geodesic5, idx_geodesic6],'MaxObjectiveEvaluations',60,'UseParallel',true,'PlotFcn',{});
