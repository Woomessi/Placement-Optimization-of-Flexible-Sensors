...
% [solution,objectiveValue] = ga(@(x)detective_rate_simple(x,target,joint_constraint,a,d,alpha,edge_candidate,point_all,edge, r_cylinder,size_point_target,fov_vertical,fov_horizontal,size_sim,h_cone,idx_link),size_var,[],[],[],[],lb,ub,[],intcon,options);
[solution,objectiveValue] = ga(@(idx_helix)detective_rate_helix(idx_helix,size_spot,target,joint_constraint,a,d,alpha,edge_candidate,point_all,edge, r_cylinder,size_point_target,fov_vertical,fov_horizontal,size_sim,h_cone,idx_link),size_var,[],[],[],[],lb,ub,[],intcon,options);