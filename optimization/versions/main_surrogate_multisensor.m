...
[solution,objectiveValue] = surrogateopt(@(x)detective_rate_multisensor_x(x, size_sim, r_obj_offset, theta_obj_offset, target_homo, q_all, size_joint, a, d, alpha, edge_candidate, point_all, edge, r_cylinder, size_spot, size_point_target, fov_vertical, fov_horizontal, h_cone, my_robot),lb,ub,intcon,options);