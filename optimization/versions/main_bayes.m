...
fun = @(x)detective_rate_helix(x.idx_helix1,size_spot,r_obj_offset,theta_obj_offset,target_homo,joint_constraint,a,d,alpha,edge_candidate,point_all,edge, r_cylinder,size_point_target,fov_vertical,fov_horizontal,size_sim,h_cone,idx_link);
results = bayesopt(fun,idx_helix,'UseParallel',true);