...
fun = @(x)detective_rate_multisensor(x.idx_helix1,x.idx_helix2,x.idx_helix3,x.idx_helix4,x.idx_helix5,x.idx_helix6,x.idx_helix7,x.spot1,x.spot2,x.spot3,x.spot4,x.spot5,x.spot6,x.spot7, size_sim, r_obj_offset, theta_obj_offset, target_homo, q_all, size_joint, a, d, alpha, edge_candidate, point_all, edge, r_cylinder, x.size_spot, size_point_target, fov_vertical, fov_horizontal, h_cone, my_robot);
results = bayesopt(fun,[size_spot,idx_helix1,idx_helix2,idx_helix3,idx_helix4,idx_helix5,idx_helix6,idx_helix7,spot1,spot2,spot3,spot4,spot5,spot6,spot7],'UseParallel',true,'GPActiveSetSize',300,'ExplorationRatio',0.5,'ParallelMethod','clipped-model-prediction','MaxObjectiveEvaluations',30,'NumSeedPoints',4);