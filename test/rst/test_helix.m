...
% 各传感器坐标系齐次变换矩阵
tform_sensor = cell(1,size_sensor);
for i = 1:size_sensor
    tform_sensor(1,i) = {[x_basis(:,i), y_basis(:,i) ,z_basis, spot(:,i); 0 0 0 1]};
end
...
% 起点可视化
scatter3(tform(1,4),tform(2,4),tform(3,4),100,"filled","MarkerFaceColor","#00FFFF")
% Z轴可视化
quiver3(tform(1,4),tform(2,4),tform(3,4),tform(1,3),tform(2,3),tform(3,3),1)
% 圆柱螺旋线可视化
...
% 传感器坐标系可视化
for i = 1:size_sensor
    quiver3(tform_sensor{1,i}(1,4),tform_sensor{1,i}(2,4),tform_sensor{1,i}(3,4),tform_sensor{1,i}(1,1),tform_sensor{1,i}(2,1),tform_sensor{1,i}(3,1),0.1,"filled",'r')
    quiver3(tform_sensor{1,i}(1,4),tform_sensor{1,i}(2,4),tform_sensor{1,i}(3,4),tform_sensor{1,i}(1,2),tform_sensor{1,i}(2,2),tform_sensor{1,i}(3,2),0.1,"filled",'g')
    quiver3(tform_sensor{1,i}(1,4),tform_sensor{1,i}(2,4),tform_sensor{1,i}(3,4),tform_sensor{1,i}(1,3),tform_sensor{1,i}(2,3),tform_sensor{1,i}(3,3),0.1,"filled",'b')
end
% 视场锥可视化
