...
% spot1 = optimizableVariable('spot1',[0,1],'Type','integer');
% spot2 = optimizableVariable('spot2',[0,1],'Type','integer');
% spot3 = optimizableVariable('spot3',[0,1],'Type','integer');
% spot4 = optimizableVariable('spot4',[0,1],'Type','integer');
% spot5 = optimizableVariable('spot5',[0,1],'Type','integer');
% spot6 = optimizableVariable('spot6',[0,1],'Type','integer');
% spot7 = optimizableVariable('spot7',[0,1],'Type','integer');
% spot8 = optimizableVariable('spot8',[0,1],'Type','integer');
% spot9 = optimizableVariable('spot9',[0,1],'Type','integer');
% spot10 = optimizableVariable('spot10',[0,1],'Type','integer');
% spot11 = optimizableVariable('spot11',[0,1],'Type','integer');
% spot12 = optimizableVariable('spot12',[0,1],'Type','integer');
% spot13 = optimizableVariable('spot13',[0,1],'Type','integer');
% spot14 = optimizableVariable('spot14',[0,1],'Type','integer');
% spot15 = optimizableVariable('spot15',[0,1],'Type','integer');
% spot16 = optimizableVariable('spot16',[0,1],'Type','integer');
% spot17 = optimizableVariable('spot17',[0,1],'Type','integer');
% spot18 = optimizableVariable('spot18',[0,1],'Type','integer');
% spot19 = optimizableVariable('spot19',[0,1],'Type','integer');
% spot20 = optimizableVariable('spot20',[0,1],'Type','integer');
