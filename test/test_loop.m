...
for round = 1:312
    ...
    if size(index_vertices,2) == 1
        ...
        if abs(vector_vertex1 - direction_vector_W) < ones(1,3)*0.01% 判断方向向量是否同顶点向量1重合
            ...
            [direction_vector_W,index_facet_current,point_current,T] = getVertexPathpoint(TR, index_vertices, position_vertices, connectivity_facets, point_current, index_facet_current, direction_vector_W, round, points_seq, indices_facets_seq, F_color);
        else
